import {createRoleplayState,setRoleplayMode,nextRoleplay,renderRoleplay} from "./roleplay.js?v=20260923-8";
import {createKingState,kingAction,renderKing} from "./kingslave.js?v=20260923-8";
import {createChessState,chessClick,chessUndo,renderChess} from "./chess.js?v=20260923-8";
import {createSnakeState,snakeRoll,snakeContinue,snakeSetMode,snakeReset,renderSnake} from "./snake.js?v=20260923-8";
import {saveMemory} from "../features/memories.js?v=20260923-8";
